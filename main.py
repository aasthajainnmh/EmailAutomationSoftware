...
class Email:
    ...
    def __init__(self, root):
        ...
        self.root.config(bg="aquamarine")
        ...
        single = Radiobutton(root, text="Single", value="single", command=self.check_single_OR_bulk,
                             activebackground="aquamarine", variable=self.var_choice, font=("times new roman", 30, "bold"),
                             bg="aquamarine", fg="black").place(x=50, y=120)
        multiple = Radiobutton(root, text="Multiple", value="multiple", command=self.check_single_OR_bulk,
                               variable=self.var_choice, activebackground="aquamarine",
                               font=("times new roman", 30, "bold"), bg="aquamarine", fg="black").place(x=200, y=120)
        ...
        title = Label(self.root, text="Bulk Email Sender Panel",font=("Goudy Old Style", 48, "bold"), bg="darkseagreen",
        ...
        REF = Label(self.root, text="Use Excel File For Sending Bulk Email At Once", font=("Calibri (body)", 14,),
                    bg="aquamarine", fg="black").place(x=0, y=80, relwidth=1)

        btn_set1 = Button(self.root, image=self.Email_icon,
                          bg="darkseagreen", bd='0', command=LEFT, height=65, width=100,activebackground="darkseagreen").place(x=1, y=4)

        btn_set = Button(self.root,image=self.Setting_icon,
                         bg="darkseagreen", bd='0', command=self.setting_window,height= 65, width=100,activebackground="darkseagreen",).place(x=890, y=4)

        #########################   text   #####################################

        To = Label(self.root, text="To (Email Address)", font=("times new roman", 18, "bold"), bg="aquamarine",
                   fg="black").place(x=50, y=200)
        Subject = Label(self.root, text="SUBJECT", font=("times new roman", 18, "bold"), bg="aquamarine",
                        fg="black").place(x=50, y=250)
        Message = Label(self.root, text="MESSAGE", font=("times new roman", 18, "bold"), bg="aquamarine",
                        fg="black").place(x=50, y=300)

        ############################################## STATUS ##################################################################

        self.Total = Label(self.root, font=("times new roman", 18, "bold"), bg="aquamarine", fg="black")
        self.Total.place(x=50, y=500)

        self.Sent = Label(self.root, font=("times new roman", 18, "bold"), bg="aquamarine", fg="darkgreen")
        self.Sent.place(x=350, y=500)

        self.Left = Label(self.root, font=("times new roman", 18, "bold"), bg="aquamarine", fg="orange")
        self.Left.place(x=450, y=500)

        self.Failed = Label(self.root, font=("times new roman", 18, "bold"), bg="aquamarine", fg="red")
        ...
        btn1 = Button(root, activebackground="aquamarine", command=self.send_email, text="SEND",
                      font=("times new roman", 20, "bold"), bg="black",
                      fg="white").place(x=700, y=500, width=130, height=30)
        btn2 = Button(root, activebackground="aquamarine", command=self.clear1, text="CLEAR",
                      font=("times new roman", 20, "bold"), bg="#ffcccb",
                      fg="black").place(x=850, y=500, width=130, height=30)
        self.btn3 = Button(root, activebackground="aquamarine", text="BROWSE", font=("times new roman", 20, "bold"),
                           bg="darkseagreen", command=self.Browse_button, cursor="hand2", state=DISABLED, fg="black")
    ...
    def setting_window(self):
        ...
        self.uname_entry = Entry(self.root2, font=("times new roman", 18), bg="lightaquamarine")
        self.uname_entry.place(x=250, y=150, width=330, height=30)

        self.pasw_entry = Entry(self.root2, font=("times new roman", 18), bg="lightaquamarine", show="*")
        ...
        btn1 = Button(self.root2, activebackground="aquamarine", text="SEND", font=("times new roman", 20, "bold"),
                      bg="black",
                      fg="white", command=self.save_setting).place(x=250, y=250, width=130, height=30)
        btn2 = Button(self.root2, activebackground="aquamarine", text="CLEAR", font=("times new roman", 20, "bold"),
